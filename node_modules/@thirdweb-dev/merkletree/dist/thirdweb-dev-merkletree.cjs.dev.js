...
var reverse__default = /*#__PURE__*/_interopDefault(reverse);
...
class MerkleTree extends Base$1 {
  duplicateOdd = false;
  concatenator = buffer.Buffer.concat;
  hashLeaves = false;
  isBitcoinTree = false;
  leaves = [];
  layers = [];
        ...
        if (i >= layerLimit) {
          ...
          if (nodes.length % 2 === 1) {
            ...
            if (this.isBitcoinTree) {
              ...
              hash = this.hashFn(this.concatenator([reverse__default["default"](data), reverse__default["default"](data)]));
              hash = reverse__default["default"](this.hashFn(hash));
