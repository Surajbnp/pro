...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (pageRoute.pathname === "/dashboardAdx/stats") {
      ...
      setPageTitle(" Manage Social Media Tasks");
              ...
              >
                <div className="flex items-center flex-row sm:flex-col w-full gap-2">
                  <img
                    src="/loader.webp"
                    alt="not"
                    className="w-[28px] sm:w-[35px]"
                  />
                  <span className="text-[13px]">{admin && admin.email}</span>
                </div>
                    ...
                    <NavLink
                      ...
                      className={`${
                        pageRoute.pathname === `${menu.link}`
                          ? "bg-[#424242] w-fit"
                          : ""
                      } px-2 py-3 flex rounded-[6px] items-center space-x-1 font-medium text-truncate`}
                    >
                      <span className=""></span>
