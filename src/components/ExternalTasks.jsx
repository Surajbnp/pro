...
const ExternalTasks = () => {
  ...
  const fetchCounter = async () => {
    const counterDoc = await getDoc(doc(db, "counters2", "taskCounter"));
    if (counterDoc.exists()) {
      return counterDoc.data().currentId;
    } else {
      await setDoc(doc(db, "counters2", "taskCounter"), { currentId: 0 });
      return 0;
    }
  };
  ...
  const incrementCounter = async () => {
    ...
    await setDoc(doc(db, "counters2", "taskCounter"), { currentId: newId });
    return newId;
  };
  ...
  return (
    <>
      {loading ? (
        ...
        <div id="refer" className="w-full flex flex-col  pt-4 pb-[150px]">
          <div className="w-full flex flex-col space-y-4">
            ...
            {successMessage && (
              <div className="modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
                ...
                <div className="modal-container bg-[#595D65] w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 ">
