...
const Levels = ({ showLevel, setShowLevel }) => {
  ...
  const [displayedLevelIndex, setDisplayedLevelIndex] =
    useState(currentLevelIndex);
          ...
          <div className="w-full pt-10 justify-center flex-col space-y-6">
            <div className="flex items-center space-x-4">
              <div className="flex flex-col items-center">
                ...
                <div className="w-full relative flex items-center justify-center">
                  <div className="absolute left-[5px]">
                    {displayedLevelIndex > 0 && (
                      <button
                        className="text-[#b0b0b0] hover:text-[#c4c4c4]"
                ...
                displayedLevelIndex < userLevels.length - 1 ? (
                  <>
                    <p className="text-[18px] font-semibold text-[#c6c6c6] px-[20px] pt-[35px] pb-[10px]">
                      {tapBalance} /{" "}
                      {formatNumberCliam(currentLevel.tapBalanceRequired)}
                    </p>
                    ...
                    <div className="w-full px-[44px]">
                      <div className="flex w-full mt-2 p-[4px] items-center bg-energybar rounded-[10px] border-[1px] border-borders2">
                        <div
                          className={`h-[8px] rounded-[8px] levelbar`}
                          style={{
                            width: `${
                              (tapBalance / currentLevel.tapBalanceRequired) *
                              100
                            }%`,
                          }}
                        />
                  ...
                  <>
                    <p className="text-[16px] font-medium text-[#c6c6c6] px-[20px] pt-[35px] pb-[10px]">
